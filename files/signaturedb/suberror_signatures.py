...
services = {
    ...
    'Heroku': {'code': '[300-499]',
               'error': r'no-such-app.html|<title>no such app</title>|herokucdn.com/error-pages/no-such-app.html'},
    'Pantheon': {'code': '[300-499]', 'error': r'The gods are wise, but do not know of the site which you seek.'},
    'Tumbler': {'code': '[300-499]',
    ...
    'Unbounce': {'code': '[300-499]',
                 'error': r'The requested URL / was not found on this server|The requested URL was not found on this server'},
    'Tictail2': {'code': '[300-499]',
                 'error': r'Building a brand of your own\?|to target URL: \<a href\=\\\"https://tictail.com|Start selling on Tictail.'},
