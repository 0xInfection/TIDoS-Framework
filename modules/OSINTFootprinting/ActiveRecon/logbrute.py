...
info = "This module tries to find log files on the target's webserver."
searchinfo = "Logfile Bruteforce"
properties = {}
...
def logbrute(web):
    ...
    try:
        ...
        pass
    if ul:
        print(G+' [+] The following possible log paths were found!'+C+color.TR2+C)
        for u in ul:
            print(O+' [+] Log File path :'+C+color.TR3+C+G+u+C+color.TR2+C)
